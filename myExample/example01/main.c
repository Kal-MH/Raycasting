...
//Since key_press() can recieve only one argument, all the argument should be gathered in one structure
...
int	main(void)
{
	...
	printf("S key : Substract 1 to x.\n");
	printf("ESC key : Exit this program.\n");
	printf("Other key : Print current x.\n");
	printf("----------------------------------\n");
	printf("Current x : 3\n");
